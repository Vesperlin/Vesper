!function() {
      ...
      , t = {
            ...
            fn: function() {
                ...
                function c(e) {
                    if (document.body.dataset.__TB_execCommand) {
                        ...
                        t[s("types")] = e.clipboardData[n.types].slice();
            ...
            fn: function() {
                const e = e => {
                    ...
                    const n = t.getBoundingClientRect()
                      ...
                      , i = new PointerEvent("pointerdown",{
                        ...s,
                        ...c,
                        buttons: 1,
                        pressure: .5
                    ...
                    t.dispatchEvent(i),
                    i.defaultPrevented || t.dispatchEvent(new MouseEvent("mousedown",{
                        ...s,
                        buttons: 1
                    })),
                ...
                ;
                return document.addEventListener("TB_customClick", e),
                () => {
        ...
        pdfHandler: {
            fn: function() {
                ...
                function t() {
                    const e = document.getElementById("__TB_pdf_iframe").contentDocument.getElementsByTagName("embed")[0];
                    e.postMessage({
                        type: "selectAll"
                    }, "*"),
                    e.postMessage({
                ...
                return document.addEventListener("TB_PDF_GetSelectedText", e),
    ...
    window.__tb_configs || Object.defineProperty(window, e, {
        enumerable: !1,
        writable: !1,
        configurable: !1,
        value: {
            remaps: Object.create(null)
        }
    });
